 ...
 */
class GroupedQueueTransport extends AbstractTransport {
	...
	public function send(Message $message): array {
		...
		// This line is intentionally changed in order to remain Email sending the usual way, without creating a Queued Job
		$result = $QueuedJobs->createJob('Queue.Email', ['transport' => $transport, 'settings' => $message->__serialize(), 'serialized' => TRUE, 'class' => get_class($message)], ['group'=>'email']);
